...
<script setup>
import FreSelectView from './FreSelectView.vue';
import { ref, computed } from 'vue'
import { whiteWine, redWine, localWine, softDrinks, hotDrinks, beers, liquors } from '@/data/frDrinks';
...
const tabLabels = {
  softDrinks: 'Rafraîchissement',
  hotDrinks: 'Cafés',
  beers: 'Bières',
  whiteWine: 'Vins blancs', 
  redWine: 'Vins rouges',    
  localWine: 'Vins locaux',
  liquors: 'Liqueurs et boissons mélangées',
}
...
<template>
  ...
  <div class="cap-footer">
    ...
    <span>Interrogez le serveur sur les allergènes</span>
    <span>Nous ne pouvons garantir la présence de traces d'un des allergènes indiqués</span>
</div> 
